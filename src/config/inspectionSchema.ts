...
export const inspectionSchema = {
  ...
  projectInformation: [
    ...
    { name: 'client_contact', label: 'Client Contact & Title', order: 5 },
    { name: 'client_rep', label: 'Client Site Rep & Title', order: 6 },
    { name: 'installer', label: 'Installer/contractor', order: 7 },
    { name: 'third_party_acr', label: '3rd Party Acr. Body', order: 8 },
    { name: 'digital_recording', label: 'Digital Recording', order: 9 },
    { name: 'storeys', label: 'Storeys', order: 10, type: 'number' },
    { name: 'structural_frame', label: 'Structural Frame', order: 11 },
    { name: 'façade', label: 'Façade', order: 12 },
    { name: 'floor_type', label: 'Floor Type',  order: 13 },
    { name: 'internal_walls', label: 'Internal Walls Types', order: 14 },
    { name: 'fire_stopping_materials', label: 'Fire Stopping Materials', order: 15 },
    { name: 'barrier_materials', label: 'Barrier Materials', order: 16 },
    { name: 'dampers', label: 'Dampers', order: 17 },
    { name: 'encasements', label: 'Encasements', order: 18 },
  ],
